    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdvertProviders", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdvertProviderId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Adverts_AdvertProviders_AdvertProviderId",
                        column: x => x.AdvertProviderId,
                        principalTable: "AdvertProviders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "AdvertApplicationUser",
                columns: table => new
                {
                    SavedAdvertsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SavedUsersId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdvertApplicationUser", x => new { x.SavedAdvertsId, x.SavedUsersId });
                    table.ForeignKey(
                        name: "FK_AdvertApplicationUser_Adverts_SavedAdvertsId",
                        column: x => x.SavedAdvertsId,
                        principalTable: "Adverts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdvertApplicationUser_AspNetUsers_SavedUsersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdvertApplicationUser_SavedUsersId",
                table: "AdvertApplicationUser",
                column: "SavedUsersId");

            migrationBuilder.CreateIndex(
                name: "IX_AdvertProviders_Name",
                table: "AdvertProviders",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Adverts_AdvertProviderId_RemoteId",
                table: "Adverts",
                columns: new[] { "AdvertProviderId", "RemoteId" },
                unique: true);
